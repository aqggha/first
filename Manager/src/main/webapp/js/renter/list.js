        ...
        success:function (resp) {
            if (resp.isSuccess){
                ...
                for (var i = 0; i < jsonObject.length; i++) {
                    ...
                    html+="<td>"+renter.phoneNumber+"</td>"
                    html+="<td>"+renter.sex+"</td>"
                    html+="<td>"+renter.nativePlace+"</td>"
                    html+="<td>"+renter.idNumber+"</td>"
                   // html+="<td>"+renter.addTime+"</td>"
                    var detailUrl="detail.html?id="+renter.id
                    var editUrl="edit.html?id="+renter.id
                    html+="<td>\n" +
